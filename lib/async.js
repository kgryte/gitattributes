...
*	Asynchronously creates a .gitattributes file.
*
* @param {String} dest - .gitattributes destination directory
* @param {Object} [opts] - function options
* @param {String} [opts.template="default"] - .gitattributes template to use
* @param {Function} [clbk] - callback to invoke upon attempting to create a .gitattributes file
*/
function cp() {
	var args = arguments,
		nargs = args.length,
	...
	fpath = path.join( __dirname, tmpl, 'gitattributes' );
	dpath = path.join( dest, '.gitattributes' );
